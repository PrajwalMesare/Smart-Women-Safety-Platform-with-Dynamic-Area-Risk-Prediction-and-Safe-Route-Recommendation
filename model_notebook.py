...
# Cell 1: Markdown - Paper Overview
cell1 = {
    "cell_type": "markdown",
    "metadata": {},
    "source": [
...
# Cell 2: Imports & Synthetic Data (matches data summary stats: 1,446 incidents, Street Lighting -0.607 corr, 25.8% dark spots, etc.)
cell2 = {
    "cell_type": "code",
...
# Cell 3: Paper's Transparent Composite Risk Model (Eq 5 & 6)
cell3 = {
    "cell_type": "code",
    "execution_count": None,
    "outputs": [],
...
# Cell 4: ML Model Training - RandomForest Regressor on synthetic data
cell4 = {
    "cell_type": "code",
    "execution_count": None,
    "outputs": [],
...
# Cell 5: Evaluation, Confidence, & Explanation (Paper Eqs 7, 9-12 risk bands)
cell5 = {
    "cell_type": "code",
    "execution_count": None,
    "outputs": [],
...
print('✅ Notebook generated successfully: Smart_Women_Safety_Model.ipynb')
print('📂 Open in JupyterLab/VS Code to view/ run all cells.')
